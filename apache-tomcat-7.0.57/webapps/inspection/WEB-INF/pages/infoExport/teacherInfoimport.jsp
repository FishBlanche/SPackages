		...
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span12">
					...
					<h3 class="page-title">教师信息导入</h3>
					<ul class="breadcrumb">
						<li><i class="icon-home"></i> <a
							style="text-decoration: none" href="${ctx}index.jsp">教师信息导入</a></li>
			...
			<div class="portlet box blue">
				...
				<div class="portlet-body">
					...
					<div class="btn-group"  >
						<a href="#teacherModal" role="button" class="btn green" style="text-decoration:none;" data-toggle="modal"   id="studentBtn" >导入教师信息</a> 
					</div>
				
					<div class="btn-group" style="margin-left: 70% !important;" >
...
<!-- 											class="icon-remove-sign icon-large" title="Delete"></i></a></td> -->
			        ...
			        <!-- 导入页面 -->
				       <div id="teacherModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="margin-top: 10%;">  
				            <div class="modal-header" style="margin-left: 5%;">  
				                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>  
				                <h3 id="myModalLabel" style="font-weight: 600;">导入教师信息</h3>  
				            </div>  
								<form id="form1" action="${ctx}app/teacherInfoController/exportfile" method="post" onsubmit="return check();"
				            ...
				            <div class="modal-body" style="margin-left: 10%;">  
								<div style="border: 1px solid rgb(204, 204, 208); width: 90%;height: 50px; background-color: rgb(245, 244, 244);  padding-top: 10px;">
									...
									<span style="font-weight: 600; margin-left: 2%; color: rgb(0, 71, 255);">导入教师信息:</span>
...
<!-- 									<div style="float: left; margin-top: -7%; margin-left: 43.5%;"> -->
<!-- 										<input type="text" id="acceptfile" -->
<!-- 											style="width: 98%; height: 32px;" /> -->
<!-- 									</div> -->

<!-- 									<div style="float: right;  margin-right: 3.5%;"> -->
<!-- 										<button id="submitBtn" type="submit" -->
<!-- 											style="height: 30px; background-color: rgb(71, 124, 239); color: white; font-weight: 600;margin-top: 6px;">确定</button> -->
<!-- 									</div> -->
							</div>
				            </div>  
	...
	<script>
		...
		function check() {
			...
			// 			if (file[0].value == "" || file[0].value == null) {
			// 				alert("请先选择文件");
			// 				return false;
			// 			}	
		...
		function del(id) {
			if (confirm("confirm delete?")) {
				$.post('${ctx}app/teacherInfoController/delete?id=' + id + '',
						'', function() {
		...
		function batchDel() {
			if(str.length==0){
				...
				if (confirm("确定删除?")) {
					$.post('${ctx}app/teacherInfoController/batchDel', {
						"att" : str
					}, function() {
						location.reload();
					});
