...
;(function(){
	...
	$.extend($.XYTipsWindow,{
		...
		init: function (o){
			...
			$(".___closeBox",$box).undelegate().delegate("click",function(){
				alert(123);
				$.XYTipsWindow.removeBox();
			}).css({zIndex:"870618"});
			if(o.___closeID != ""){
				$("#"+o.___closeID,$box).undelegate().delegate("click",function(){
					$.XYTipsWindow.removeBox();
				});
			};
			if(o.___time != "") {
			...
			$("#"+o.___boxID).undelegate().delegate("mouseenter",function(){
				BOXID = o;
			});
		},
		getID: function(){
		...
		showBox: function(o) {
			...
			var $boxDom = "<div id=\""+o.___boxID+"\" class=\"XYTipsWindow\">";
				...
				$boxDom += "<div class=\"___boxTitle\"><h3></h3><span class=\"___closeBox\" onclick=\"closeBox();\">关闭</span></div>";
		...
		setBoxzIndex: function (o) {
			...
			$box.undelegate().delegate("click",function(){
...
function closeBox(){
	$.XYTipsWindow.removeBox();
//	$(".___closeBox",$box)css({zIndex:"870618"});
