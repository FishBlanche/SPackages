...
<body class="page-header-fixed" style="background-color:#fff">
		...
		<div class="page-content" style="margin-left:0px;margin-top:42px">
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption"><i class="icon-reorder"></i>时间</div>
					<div class="tools">
				...
				<div class="portlet-body">
					<div id="timeline" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
				</div>
			</div>
			...
			<div class="portlet box red">
				<div class="portlet-title">
					<div class="caption"><i class="icon-calendar"></i>数据表盘</div>
					<div class="actions">
			...
			<div class="portlet box yellow">
				<div class="portlet-title">
					<div class="caption"><i class="icon-reorder"></i>分布</div>
					<div class="tools">
									<a href="javascript:;" class="collapse"></a>
									<a href="javascript:;" class="remove"></a>
					</div>
				...
				<div class="portlet-body">
					<div id="3dtopo" style="height: 400px"></div>
				</div>
			</div>
			...
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption"><i class="icon-reorder"></i>百分比</div>
					<div class="tools">
									<a href="javascript:;" class="collapse"></a>
									<a href="javascript:;" class="remove"></a>
					</div>
				...
				<div class="portlet-body">
					<div id="pie" style="min-width: 600px; height: 400px; margin: 0 auto"></div>
				</div>
			</div>
			</div>
		<!-- END PAGE -->
	...
	<script src="${ctx}js/highcharts/modules/data.js"></script>
	<script src="${ctx}js/highcharts/modules/heatmap.js"></script>
	...
	var codata=[{
		...
		jQuery(document).ready(function() {    
		   App.init(); // initlayout and core plugins
 		   Index.initMiniCharts();//数据表盘 服务器状况
		});
		function change(){
			console.log("类型："+document.getElementById("acc").className);
			document.getElementById("acc").className="number visits easyPieChart";
			console.log("类型："+document.getElementById("acc").className);
            var newValue = 25;
            $("#acc").data('easyPieChart').update(newValue);
            $('span', "#acc").text(newValue);
		}
